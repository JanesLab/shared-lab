...
bivariatedist_MI <- function(data,nbins,lowstatesplit){
  ...
  MIcalc<-function(data,nbins,lowstatesplit){
    ...
    #Order data from low to high and then divide uniformly distributed variables into low and high state
    NRF2_sort<-sort(NRF2_uniform)
    p53_sort<-sort(p53_uniform)
